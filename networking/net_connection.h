...
namespace olc
{
	namespace net
	{
		// Forward declare, little spaghetti
		template<typename T>
		...
		public:
				...
				: m_asioContext(asioContext), m_socket(std::move(socket)), m_qMessagesIn(qIn)
			{
				...
				// Construct validation check of data
				...
				{
					// Connection is Client -> Server, so there is nothing to define
					m_HandshakeIn = 0;
					m_HandshakeOut = 0;
				}
			}
		...
		private:
			...
			// "Encrypt" data
			// this is not actually a good solution and can't really
